...
namespace Anatole.DeChauveron.FaceDetection;
...
public class FaceDetection
{
        ...
        imagesSceneData, String mode = "ASYNC")
    {
        ...
        IList<FaceDetectionResult> detectionResults = new List<FaceDetectionResult>();
        foreach (var image in imagesSceneData)
        {
            detectionResults.Add(FaceDetectionInScene(image));
        }
    ...
    private FaceDetectionResult FaceDetectionInScene(byte[] imageScr)
    {
        ...
        return new FaceDetectionResult
        {
            ...
            Points = faces.Select(point => new ObjectDetectionPoint
            {
                X = point.X,
                Y =
                    point.Y
